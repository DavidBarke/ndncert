...
def presentation_proof_send_request_body(connection_id, presentation_request):
    return {
        ...
        "presentation_request": json.loads(presentation_request),
        "trace": False
    }
...
async def main():
    ...
    parser.add_argument("--presentation_request", required=True)
    ...
    async with ClientSession(args.endpoint) as session:
        ...
        ppsr_body = presentation_proof_send_request_body(connection_id, args.presentation_request)
