...
def build(bld):
    ...
    bld(features='subst',
        name='ndncert-vc-challenge-send-presentation-request',
        source='ndncert-vc-challenge-send-presentation-request.py',
        target='bin/ndncert-vc-challenge-send-presentation-request',
        install_path='${BINDIR}',
        chmod=Utils.O755)
    
    bld(features='subst',
        name='ndncert-vc-challenge-verify-presentation',
        source='ndncert-vc-challenge-verify-presentation.py',
        target='bin/ndncert-vc-challenge-verify-presentation',
        install_path='${BINDIR}',
        chmod=Utils.O755)
